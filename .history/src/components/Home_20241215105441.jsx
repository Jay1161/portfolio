...
function Home() {
  ...
  return (
    <section
      ...
      //className="relative flex justify-center items-center min-h-screen pt-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-slate-800 font-poppins transition-colors duration-300"
      className="relative flex justify-center items-center min-h-screen pt-20 bg-gradient-to-b from-gray-100 to-blue-50 dark:from-navy-900 dark:to-slate-800 font-poppins transition-colors duration-300"
    >
