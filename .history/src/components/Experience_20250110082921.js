...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Developed a high-performance mobile app using Fl, Firebase, and Material UI, enhancing user experience and refining app efficiency with modern development practices.",
      icon: Smartphone,
      logoUrl: ekaantik,
