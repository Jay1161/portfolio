        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full items-center px-4 z-10">
          <div className="text-gray-800 dark:text-white">
            ...
            <div className="mt-8 flex gap-4">
              ...
              <button
                onClick={handleView}
                className="bg-black dark:bg-white text-white dark:text-black px-6 py-3 rounded-lg border border-black dark:border-white hover:opacity-90 transition- inline-flex items-center gap-2 group"
              >
                <span>View Resume</span>
                <Eye className="w-5 h-5 transition-transform group-hover:scale-110" />
              </button>
