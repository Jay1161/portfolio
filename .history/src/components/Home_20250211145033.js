...
import { SiX, SiLinkedin, SiGithub, SiImessage, SiGmail, SiMaildotru, SiMinutemailer, SiProtonmail } from "react-icons/si";
          ...
          <div className="text-gray-800 dark:text-white">
            ...
            <div className="flex gap-4 mb-8">
              {[
                ...
                { icon: SiProtonmail, href: "mailto:jayvaja56@gmail.com" },
              ].map((social, index) => (
                <a
                  key={index}
                  href={social.href}
