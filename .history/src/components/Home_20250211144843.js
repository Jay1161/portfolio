...
import { SiX, SiLinkedin, SiGithub, SiImessage, SiGmail } from "react-icons/si";
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full items-center px-4 z-10">
          <div className="text-gray-800 dark:text-white">
            ...
            <div className="flex gap-4 mb-8">
              {[
                { icon: SiLinkedin, href: "https://www.linkedin.com/in/jay-vaja-b84237229/",},
                { icon: SiGithub, href: "https://github.com/Jay1161" },
                { icon: SiX, href: "https://x.com/jayvaja_11" },
                { icon: SiEmail, href: "mailto:jayvaja56@gmail.com" },
              ].map((social, index) => (
                <a
                  key={index}
                  href={social.href}
