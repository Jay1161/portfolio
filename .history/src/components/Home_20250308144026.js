...
function Home() {
  ...
  const resumePath =
    "https://drive.google.com/file/d/1Wg53elmH95uLCRuJ3m0dQ6nfSKikOhOi/view?usp=sharing";
  ...
  return (
    <section
      id="home"
      className="relative flex justify-center items-center min-h-screen pt-20 bg-black text-white"
    >
      ...
      <div className="relative z-10 text-center">
        <h1 className="text-5xl font-bold mb-2">Hi!, I'm Jay Vaja</h1>
        <h2 className="text-2xl mb-4">
          I'm a{" "}
          <span className="text-orange-500 dark:text-blue-400">
            <ReactTyped
        ...
        <div className="flex justify-center gap-4 mb-8">
          {[
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-orange-500 hover:text-opacity-80 transition-colors"
            >
              <social.icon size={24} />
            </a>
          ))}
        ...
        <button
          onClick={handleView}
          className="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition-colors inline-flex items-center gap-2 group"
        >
          <span>View Resume</span>
          <Eye className="w-5 h-5 transition-transform group-hover:scale-110" />
        </button>
