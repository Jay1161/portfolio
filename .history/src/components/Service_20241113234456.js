...
import { Code2, Layout, Server, Database, Shield, Cloud, Smartphone, Infinity } from "lucide-react";
...
const Services = () => {
  const services = [
    ...
    //   title: "UI/UX Design",
    //   description:
    //     "Creating intuitive and engaging user interfaces with focus on user experience and accessibility.",
    //   icon: Layout,
    ...
    //   description:
    //     "Developing robust server-side applications and RESTful APIs for seamless data management.",
    //   icon: Server,
    //   skills: ["Express.js", "MongoDB", "PostgreSQL", "API Design"],
    // },
  ];
