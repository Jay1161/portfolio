...
const Footer = () => {
  ...
  return (
    <footer
      ...
      className="relative flex justify-center items-center min-h-screen pt-20 bg-yellow-50 dark:bg-slate-900 text-black dark:text-white font-rubik transition-colors duration-300"
    >
