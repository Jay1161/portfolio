...
function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 shadow-md z-50 px-4 md:px-8 py-4 font-rubik transition-colors duration-300">
        <div className="container mx-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              {/* Theme Toggle Button */}
              <div className={`relative w-12 h-8 ${isDark ? 'night' : ''} ${isAnimating ? 'animate' : ''}`}>
                <button
                  onClick={toggleTheme}
                  ...
                  <div className="w-7 h-10 overflow-hidden absolute left-2.5 -top-1.5 rounded-b-lg">
                    ...
                    >
                      ...
                      <g className="animate-twinkle origin-[15px_3px]">
                        <line x1="15" y1="1" x2="15" y2="5" className="stroke-[#ddeafb]"/>
                        <line x1="13" y1="3" x2="17" y2="3" className="stroke-[#ddeafb]"/>
                      </g>
                      <g className="animate-twinkle-2 origin-[21px_9px]">
                        <line x1="21" y1="7" x2="21" y2="11" className="stroke-[#ddeafb]"/>
                        <line x1="19" y1="9" x2="23" y2="9" className="stroke-[#ddeafb]"/>
                      </g>
                    </svg>
                  </div>
                </button>
