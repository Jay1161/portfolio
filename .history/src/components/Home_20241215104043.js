...
function Home() {
  ...
  return (
    <section
      id="home"
      className="relative flex justify-center items-center min-h-screen pt-20 bg-gradient-to-b from-white-50 to--500 dark:from-gray-900 dark:to-gray-900 font-poppins transition-colors duration-300"
    >
