...
function Home() {
  ...
  return (
    <section
      ...
      className="relative flex justify-center items-center min-h-screen pt-20 bg-white dark:bg-gray-900 text-black dark:text-white font-poppins transition-colors duration-300"
    >
